    ...
    <section className="hero hero--v3 ico-progress ico-progress--v2 section--dark bg-color--dark--1 d-flex align-items-center hidden">
        ...
        <div className="row">
          <div className="col-12 col-md-10 col-lg-8 px-lg-0 mx-auto mb-3 mb-lg-0 mt-8 mt-lg-0 text-center z-index2">
            <div className="hero-content">
              ...
              <button
                className="btn btn-bg--cta--4 rounded--full btn-hover--3d btn-hover--splash mb-2 mx-1 smooth-scroll"
                onClick={() => setSmShow(true)}
              >
                <span className="btn__text d-flex align-items-center">
                  <i className="fa fa-coins color--white pr-1 h6-font font-w--700"></i>
                  Buy token
                </span>
              </button>
            </div>
      ...
      >
        <Modal.Body style={{ height: 550 }}>
          <iframe
            src="https://iframe-pancakeswap.netlify.app?outputCurrency=0xBc7d6B50616989655AfD682fb42743507003056D"
